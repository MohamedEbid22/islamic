...
class NoomZekr extends StatefulWidget {
  const NoomZekr({super.key});

  @override
  State<NoomZekr> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<NoomZekr> {
  @override
