...
class TaameZekr extends StatefulWidget {
  const TaameZekr({super.key});

  @override
  State<TaameZekr> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<TaameZekr> {
  @override
