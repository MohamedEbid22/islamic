...
class MotafarekZekr extends StatefulWidget {
  const MotafarekZekr({super.key});

  @override
  State<MotafarekZekr> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<MotafarekZekr> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        FutureBuilder<List<Azker>>(
          future: MyAzker.getMotafarekZekr(),
