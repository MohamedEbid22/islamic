...
class AzenZekr extends StatefulWidget {
  const AzenZekr({super.key});

  @override
  State<AzenZekr> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<AzenZekr> {
  @override
