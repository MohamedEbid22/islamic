...
class SalaaZekr extends StatefulWidget {
  const SalaaZekr({super.key});

  @override
  State<SalaaZekr> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<SalaaZekr> {
  @override
