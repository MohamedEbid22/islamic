...
import 'package:islamic/core/class/PositionData.dart';
import 'package:islamic/core/constant/color.dart';
import 'package:islamic/view/screen/Home/imageaudio.dart';
import 'package:just_audio/just_audio.dart';
import 'package:lottie/lottie.dart';
import 'package:rxdart/rxdart.dart' as rxdart;

class ReadQuranAudio extends StatefulWidget {
  @override
  _QiblahCompassState createState() => _QiblahCompassState();
}

class _QiblahCompassState extends State<ReadQuranAudio> {
  ...
  Future<void> _initAudioPlayer() async {
    try {
      ...
      await _audioPlayer.setUrl(controller.quran.audoi);
