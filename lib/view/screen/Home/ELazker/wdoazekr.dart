...
class WedoaaZekr extends StatefulWidget {
  const WedoaaZekr({super.key});

  @override
  State<WedoaaZekr> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<WedoaaZekr> {
  @override
