...
class KalaaZekr extends StatefulWidget {
  const KalaaZekr({super.key});

  @override
  State<KalaaZekr> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<KalaaZekr> {
  @override
