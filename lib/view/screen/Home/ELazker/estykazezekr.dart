...
class EstykazeZekr extends StatefulWidget {
  const EstykazeZekr({super.key});

  @override
  State<EstykazeZekr> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<EstykazeZekr> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        FutureBuilder<List<Azker>>(
          future: MyAzker.getEstykazeZekr(),
