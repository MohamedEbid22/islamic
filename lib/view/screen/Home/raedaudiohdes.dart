...
class ReadHdethAudio extends StatefulWidget {
  @override
  _QiblahCompassState createState() => _QiblahCompassState();
}

class _QiblahCompassState extends State<ReadHdethAudio> {
  ...
  Future<void> _initAudioPlayer() async {
    try {
      await _audioPlayer.setUrl(controller.h.audioHadith);
                                ...
                                child: Column(
                                  children: [
                                    Padding(
                                      ...
                                      child:
                                          Image.asset('asset/images/hadth.png'),
                                    ),
