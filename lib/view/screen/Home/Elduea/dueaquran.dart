...
class DueaQuran extends StatefulWidget {
  const DueaQuran({super.key});

  @override
  State<DueaQuran> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<DueaQuran> {
  @override
