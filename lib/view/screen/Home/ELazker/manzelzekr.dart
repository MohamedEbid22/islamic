...
class ManzeleZekr extends StatefulWidget {
  const ManzeleZekr({super.key});

  @override
  State<ManzeleZekr> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<ManzeleZekr> {
  @override
