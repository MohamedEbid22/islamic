...
class MorningZker extends StatefulWidget {
  const MorningZker({super.key});

  @override
  State<MorningZker> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<MorningZker> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        FutureBuilder<List<Azker>>(
          future: MyAzker.getMorningAzkar(),
