...
class DueaToMayet extends StatefulWidget {
  const DueaToMayet({super.key});

  @override
  State<DueaToMayet> createState() => _MorningZkerState();
}

class _MorningZkerState extends State<DueaToMayet> {
  @override
